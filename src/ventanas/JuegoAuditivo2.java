...
public class JuegoAuditivo2 extends javax.swing.JFrame {

    public JuegoAuditivo2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 250, 340));
    ...
    private void jButton_Juego1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Juego1ActionPerformed
        try {
            ...
            URI uri = new URI("https://www.cokitos.com/escribir-nombres-de-animales-en-espanol/");
    ...
    private void jButton_Juego2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Juego2ActionPerformed
       try {
            ...
            URI uri = new URI("https://www.cokitos.com/adivinar-sonidos/play/#google_vignette");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JuegoAuditivo2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JuegoAuditivo2().setVisible(true);
            }
        });
    }
